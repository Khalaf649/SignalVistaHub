...
import {
  fetchDopplerAudio,
  fetchDopplerPlotData,
  type DopplerPlotData,
} from "../api/doppler";
      ...
      toast({
        ...
        description:
          error instanceof Error
            ? error.message
            : "Failed to generate Doppler sound. Please try again.",
        variant: "destructive",
      });
    } finally {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Typical: 650 Hz (ambulance siren)
            </p>
          </div>
          <div className="space-y-2">
        ...
        <Card className="p-6 bg-card">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Use headphones for best 8D panning effect (left to right as source
              passes)
            </p>
          </div>
        </Card>
                ...
                data={[
                  {
                    ...
                    name: "Frequency (Hz)",
                    hovertemplate:
                      "Time: %{x:.2f}s<br>Frequency: %{y:.1f} Hz<extra></extra>",
                  },
                ]}
                layout={{
                  height: 400,
                ...
                data={[
                  {
                    ...
                    name: "Amplitude",
                    hovertemplate:
                      "Time: %{x:.2f}s<br>Amplitude: %{y:.3f}<extra></extra>",
                  },
                ]}
                layout={{
                  height: 400,
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-4 rounded-lg bg-muted/50 border border-border">
                  ...
                  <p className="text-3xl font-bold text-chart-1">
                    {plotData.stats.max_observed?.toFixed(1)} Hz
                  </p>
                </div>
                <div className="text-center p-4 rounded-lg bg-muted/50 border border-border">
                  <p className="text-sm text-muted-foreground mb-2 font-medium">
                  ...
                  <p className="text-3xl font-bold text-chart-1">
                    {plotData.stats.min_observed?.toFixed(1)} Hz
                  </p>
                </div>
                <div className="text-center p-4 rounded-lg bg-muted/50 border border-border">
                  <p className="text-sm text-muted-foreground mb-2 font-medium">
                  ...
                  <p className="text-3xl font-bold text-chart-2">
                    {plotData.stats.shift_ratio?.toFixed(3)}x
                  </p>
                </div>
              </div>
            </Card>
