    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Upload drone audio for AI-powered classification and analysis
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
      ...
      {predictionResult && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              AI classification results for the uploaded audio
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground max-w-md">
                Select an audio file containing drone sounds to classify the
                drone type using AI-powered analysis. The system will return the
                classification, confidence level, and processing status.
              </p>
            </div>
          </CardContent>
        </Card>
